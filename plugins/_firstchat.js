...
*Powered By @${global.owner[1].split('@')[0]}*`
    if (new Date - user.pc < 86400000) return // setiap 24 jam sekali
        await conn.send3ButtonLoc(m.chat, await conn.resize(await (await fetch('https://telegra.ph/file/c4c3f666673ad816d4813.jpg')).buffer(), 300, 200), `${ucapan()}, @${m.sender.split`@`[0]}
